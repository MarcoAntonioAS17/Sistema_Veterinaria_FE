...
export default function EnhancedTable(props) {
    ...
    function delete_cate(item) {
        handleDialogOpen();
        axios.delete ("http://localhost:50563/api/Categorias/" + item.idCategorias,{
            headers: {
    ...
    useEffect(() =>{
        ...
        Promise.all([
            fetch("http://localhost:50563/api/Categorias/",{
                signal: ac.signal,
                method: 'GET',
                mode: 'cors',
                headers: {
                        ...
                        >
                            ...
                            <DialogContent>
                                <DialogContentText id="alert-dialog-description">
                                    ¿Eliminar categoría {item !=null? item.nombre: ""}?
                                </DialogContentText>
                            </DialogContent>
                            <DialogActions>
                                ...
                                <Button onClick={() => delete_cate(item)} color="secondary" >
                                    Eliminar
                                </Button>
                            </DialogActions>
                        </Dialog>
