...
const headCells = [
    { id: 'idVentas', numeric: true, label: 'Código' },
    { id: 'rUsuarioNombre', numeric: false,  label: 'Atendió' },
    { id: 'rClienteNombre', numeric: false,  label: 'Cliente' },
...
export default function TablaVentas() {
    ...
    const [orderBy, setOrderBy] = React.useState('idVentas');
                                    ...
                                    {stableSort(rows, getComparator(order, orderBy))
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell >{row.rClienteNombre}</TableCell>
                        ...
                        >
                            ...
                            <DialogContent>
                                <DialogContentText id="alert-dialog-description">
                                    ¿Eliminar venta {item !=null? " ID "+item.idVentas: ""}?
                                </DialogContentText>
                            </DialogContent>
                            <DialogActions>
