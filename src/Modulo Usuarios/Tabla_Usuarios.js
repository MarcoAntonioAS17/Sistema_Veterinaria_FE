...
const headCells = [
    { id: 'userName', numeric: true, label: 'Usuario' },
    { id: 'nivel', numeric: false,  label: 'Nivel' },
];
                                    ...
                                    {stableSort(rows, getComparator(order, orderBy))
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell >{row.nivel === 1? "Administrador" : "Empleado"}</TableCell>
                                                <TableCell >
                            ...
                            >
                                ...
                                <DialogContent>
                                    <DialogContentText id="alert-dialog-description">
                                        ¿Eliminar usuario {item !=null? item.userName: ""}?
                                    </DialogContentText>
                                </DialogContent>
                                <DialogActions>
