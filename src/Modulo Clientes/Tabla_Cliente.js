...
export default function EnhancedTable(props) {
    ...
    function delete_clie(id, item) {
        handleDialogOpen();
        axios.delete ("http://localhost:50563/api/Clientes/" + id)
            .then(response => {
                                    ...
                                    {stableSort(rows, getComparator(order, orderBy))
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell >
                                                    <IconButton color="secondary" edge="end" onClick={handleDialogOpen}>
                                                        <Delete />
                                                    </IconButton>
                                                    <Dialog
                                                        fullWidth={true}
                                                    ...
                                                    >
                                                        ...
                                                        <DialogActions>
                                                            ...
                                                            <Button onClick={() => delete_clie(row.idClientes,row)} color="secondary" >
                                                                Eliminar
                                                            </Button>
                                                        </DialogActions>
                                                    </Dialog>
