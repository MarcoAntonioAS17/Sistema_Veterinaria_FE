...
const headCells = [
    { id: 'idCompras', numeric: true, label: 'Código' },
    { id: 'rUsuarioNombre', numeric: false,  label: 'Usuario' },
...
export default function TablaCompras() {
    ...
    const [orderBy, setOrderBy] = React.useState('idCompras');
    ...
    useEffect(() =>{
        ...
        Promise.all([
            fetch("http://localhost:50563/api/Compras",{
                signal: ac.signal,
                method: 'GET',
                mode: 'cors',
                headers: {
    ...
    function delete_item(item) {
        handleDialogOpen();
        axios.delete ("http://localhost:50563/api/Compras/" + item.idCompras,{
                headers: {
                    'Accept': 'application/json',
                    'Content-type': 'application/json',
                    'Authorization': 'Bearer ' + Token
                                    ...
                                    {stableSort(rows, getComparator(order, orderBy))
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell >{row.rUsuarioNombre}</TableCell>
                        ...
                        >
                            ...
                            <DialogContent>
                                <DialogContentText id="alert-dialog-description">
                                    ¿Eliminar compra {item !=null? " ID "+item.idCompras: ""}?
                                </DialogContentText>
                            </DialogContent>
                            <DialogActions>
